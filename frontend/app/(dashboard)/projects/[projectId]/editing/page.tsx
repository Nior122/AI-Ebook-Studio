...
// Editing module — bridges to the real Phase 6 book-writing editor review tab.
...
import { IconLayout, IconAlert } from "@/components/ui/icons";

export default function EditingModulePage({ params }: { params: Promise<{ projectId: string }> }) {
      ...
      <CardContent className="flex flex-col items-center gap-3 p-8 text-center">
        {books && books.length > 0 ? (
          <>
            ...
            <h2 className="text-lg font-semibold">Opening review editor…</h2>
          </>
        ) : (
          <>
            ...
            <p className="max-w-md text-sm text-muted-foreground">
              Create a new project to enable editing.
            </p>
          </>
        )}
      </CardContent>
